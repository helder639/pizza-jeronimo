class PizzaPage{
    ...
    selectorList(){
        const selectors = {
            ...
            pizzas: "[onclick='mostrarTamanhos(this)']",
    ...
    compraSalgada(){
        ...
        // Apos confirmar o envio o cypress tenta abrir o whatsApp porém nele nada é mostrado, mas ao tentar realizar os mesmos passos pelo site, logo apos confirmar o envio, um pdf confirmando a compra é baixado.
